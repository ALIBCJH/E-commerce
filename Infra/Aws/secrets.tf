...
locals {
  ...
  # This is a valid ed25519 public key for CI/CD placeholder use only
  default_ssh_key = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGL4/fSO+MSKNcG+fLDGcHPZdimDXeGbzDI8Czzk7FBi github-actions@placeholder"
